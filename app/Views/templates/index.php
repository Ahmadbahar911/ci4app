...
<head>
    ...
    <!-- CSS Files -->
    <link id="pagestyle" href="<?= base_url(''); ?>/css/material-dashboard.css?v=3.0.0" rel="stylesheet" />
    <style>
        .footer {
            width: 100%;
            height: 200px;
...
<body class="g-sidenav-show bg-gray-200">
    ...
    <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
        ...
        <?= $this->renderSection('chat_users'); ?>
        <?= $this->renderSection('chatting'); ?>
                ...
                <div class="row align-items-center justify-content-lg-between">
                    <div class="col-lg-6 mb-lg-0 mb-4">
                        <div class="copyright text-center text-sm text-muted text-lg-start">
                            ...
                            <a href="" class="font-weight-bold" target="_blank">AA Development</a>
                            Politeknik Jember.
                        </div>
                    </div>
                </div>
    ...
    <script src="<?= base_url(''); ?>/js/material-dashboard.min.js?v=3.0.0"></script>
    <script>
